package com.goaltracker.user.infrastructure.exception;

import com.goaltracker.user.domain.exception.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErroResponse> handleUsernameAlreadyExistsException(
    ...
    public ResponseEntity<ApiErroResponse> handleUnderageUserException(
            FieldsNullException e, HttpServletRequest request){
        ApiErroResponse response = new ApiErroResponse(
                HttpStatus.BAD_REQUEST.value(),
                HttpStatus.BAD_REQUEST.getReasonPhrase(),
                e.getMessage(),
    ...
    public ResponseEntity<ApiErroResponse> handleUserAlreadyExistsException(
            PasswordInvalidException e, HttpServletRequest request){
        ApiErroResponse response = new ApiErroResponse(
                HttpStatus.BAD_REQUEST.value(),
                HttpStatus.BAD_REQUEST.getReasonPhrase(),
                e.getMessage(),
